...
INSERT INTO unidadmedidas (tipoMedida, descripcion) VALUES ("M/CM","Si un producto se vende por centímetros o metros, Usa enteros y 2 decimales para agranel");
...
CALL InsertarProducto(idCategoria,idUnidadMedida, codigoBarras, p_nombre, descripcion, p_cantidadActual, p_cantidadMinima, precioCompra, 
